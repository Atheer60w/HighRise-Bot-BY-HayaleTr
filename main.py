...
class Bot(BaseBot):
    ...
    async def on_user_join(self, user: User) -> None:
        ...
        giriş_mesaj = [f"\nHayaleTrnin Odasına Hoşgeldin Bot Komutları Botun Biografisinde Yazıyor {user.username}", f"\nDostum Hoşgeldin Destek Olmak İçin Tipse 1k Lütfen {user.username}"]
...
#burdaki komutlarda sıkıntı var çözmek gerek
        ...
        if message.startswith("!t-c"):
            word_list = ["1 TEK", "3 TEK", "5 TEK", "7 TEK", "9 TEK", "11 TEK", "13 TEK", "15 TEK"]
            random_word = random.choice(word_list)
        ...
        if message.startswith("!t-ç"):
            word_list = ["2 ÇİFT", "4 ÇİFT", "6 ÇİFT", "8 ÇİFT", "10 ÇİFT", "12 ÇİFT", "14 ÇİFT"]
            random_word = random.choice(word_list)
            await self.highrise.chat(f"\nZar 🎲 Dönüyor Lütfen Bekleyin")
...
if __name__ == "__main__":
    room_id = "64ac6e1693a583a5a997ce18"
    token = "ca8a74c771ba23bbde4524530fb09533c437072f5a813b0ad718327d7018fcd1"
